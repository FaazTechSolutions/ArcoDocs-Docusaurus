...
Package is used to create pricing details based on nationality,job specification and package type,the created package will be used in the contract creation,
...
**Amount Details:**
  ...
  - Advance Amount (Period(NoofMonths) * MonthlyInstallment)
  - Monthly Installment
  - Total Amount
...
### 3.Fixed Package Setup (for Mobile App Display)
